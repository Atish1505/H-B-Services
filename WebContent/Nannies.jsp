...
<main id="main">
    ...
    <section id="portfolio" class="portfolio">
     ...
     <%  HelperDao dao = new HelperDao();
         List<helperEntity> list = dao.getNannieshelperData();
          ...
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up">
            <ul id="portfolio-flters">
             <li data-filter="*" class="filter-active"><a href="service.jsp">All</a></li>
              ...
              <li data-filter=".filter-nanni"><a href = "#">Nannies</a></li>
              <li data-filter=".filter-watchman"><a href="Watchman.jsp">Watchman</a></li>
