...
<main id="main">
    ...
    <section id="portfolio" class="portfolio">
     ...
     %>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center" data-aos="fade-up">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card"><a href="Cook.jsp">Cook</a></li>
        ...
        <%
          for(helperEntity h : list){ %>
        	<a href="portfolio-details.jsp?id=<%=h.getHpid() %>"> 
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-data">
                ...
                <div class="portfolio-links">
                  <a href="portfolio-details.jsp?id=<%=h.getHpid() %>" ><button type="button" class="btn btn-outline-success btn-sm">Get More Details</button></a>
                </div>
              </div>
            </div>
          </div>
