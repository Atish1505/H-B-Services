...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" Action ="SignUpCustomer" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "lookfor is required">
						<input class="input100" type="text" name="Lookfor" placeholder="Looking for">
						<span class="focus-input100"></span>
						
					</div>
					
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" value="SignupCustomer">
							Register
						</button>
					</div>
