...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form  class="login100-form validate-form" action="SignInCustomer" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Pwd is required">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="RegCustomer.jsp">
							Create your Account
